...
const tracerLib = require('../../src/tracer');
...
describe('Tracer lib', function () {
    ...
    describe('Tracer', () => {
        ...
        describe('.startSpan', () => {
            it('should return no-op tracer span when disabled', () => {
                ...
                assert.isTrue(span instanceof tracerLib.TraceBaseSpan);
                assert.isFalse(span instanceof tracerLib.TraceSpan);
            });
            ...
            it('should return tracer span when enabled', () => {
                const span = tracer.startSpan('opName');
                assert.isTrue(span instanceof tracerLib.TraceSpan);
    ...
    describe('Util', () => {
        describe('buildDeviceTags', () => {
            it('should build correct deviceInfo tags', () => {
                const deviceInfo = {
                    ...
                    build: '0.0.2',
                    restFrameworkVersion: '14.1.2-0.0.2',
                    isClustered: false,
                    isVirtual: true,
                    generation: 0,
                    lastUpdateMicros: 0,
                ...
                assert.deepStrictEqual(tracerLib.TraceUtil.buildDeviceTags(deviceInfo), {
                    'device.platform': 'Z100',
                    'device.platform_name': 'BIG-IP Virtual Edition',
                    'device.product': 'BIG-IP',
                    'device.version': '14.1.2',
                    'device.build': '0.0.2',
        ...
        describe('getDeclClassList', () => {
            const traceUtil = tracerLib.TraceUtil;
            it('should return empty array with no declaration', () => assert.deepStrictEqual(
                traceUtil.getDeclClassList(tracer),
                []
            ));
            ...
            it('should return empty array with disabled tracer', () => {
                ...
                assert.deepStrictEqual(
                    traceUtil.getDeclClassList(tracer, declaration),
                    []
                );
            });
            ...
            it('should handle declaration arrays', () => {
                ...
                assert.deepStrictEqual(
                    traceUtil.getDeclClassList(tracer, declarations),
