...
class Tracer {
    ...
    constructor(serviceName, options) {
        ...
        if (options.logger) {
            options.logger.debug = options.logger.debug || options.logger.fine;
        }
...
class Util {
     ...
     *
     * @returns {Object} - device info tags
     */
    ...
    /**
     *  Returns an array of declaration class names which can then be used as a tag or event log
     *
     * @param {Object} tracer - tracer instance
     * @param {Object} declaration - the declaration used
     *
     * @returns {Array} - declaration class names
     */
    static getDeclClassList(tracer, declaration) {
